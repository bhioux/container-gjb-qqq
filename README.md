...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gjb-qqq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gjb-qqq.containers.anotherwebservice.com/
...
```
git clone git@github.com:bhioux/container-gjb-qqq.git
cd container-gjb-qqq
```
...
```
docker attach container-gjb-qqq
```
